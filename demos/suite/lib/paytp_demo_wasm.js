/* @ts-self-types="./paytp_demo_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function d03_oneshot_trace(amount) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.d03_oneshot_trace(amount);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @param {bigint} amount
 * @param {boolean} os_absent
 * @returns {string}
 */
export function d05_split_trace(amount, os_absent) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.d05_split_trace(amount, os_absent);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function d06_rail_trace() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.d06_rail_trace();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function d07_coexistence_trace() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.d07_coexistence_trace();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function d08_reconnect_trace() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.d08_reconnect_trace();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function d09_attack_trace(attack) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(attack, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.d09_attack_trace(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @param {boolean} postpay
 * @param {number} requests
 * @returns {string}
 */
export function d_channel_trace(postpay, requests) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.d_channel_trace(postpay, requests);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('paytp_demo_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
